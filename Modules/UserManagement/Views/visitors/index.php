                    ...
                    <div class="form-group">
                      ...
                      <select id="attendee" class="form-control" name="attendee" >
                        ...
                        <?php foreach($schedlabs as $sched):?>
                          <option value="<?= $sched['id'];?>" <?= ($sched['id'] == $attendee ) ? 'selected':''?>><?= $sched['event_name'];?> </option>
                        <?php endforeach;?>
                        <option value="others" <?= ($attendee == 'others') ? 'selected':''?>>Others</option>
