...
class UsersModel extends \CodeIgniter\Model
{
    ...
    protected $allowedFields = ['last_name', 'first_name','m_initial', 'username','address','contact_num','email', 'password', 'role_id','profile_image', 'status', 'created_at','updated_at', 'deleted_at', 'title', 'description'];
