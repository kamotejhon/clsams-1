...
class Schedlabs extends BaseController {
  ...
  public function add(){
    ...
    if($this->request->getMethod() === 'post'){
      if($this->validate('schedlabs')){
        ...
        if(array_intersect($_POST['date'], $holi )){
          ...
          return redirect()->to(base_url('admin/schedlabs/add'));
            ...
            $this->session->setFlashData('success', 'Sucessfuly created a scheduled event');
        } 
      ...
      if($this->validate('schedlabs')){
        ...
        if(in_array($_POST['date'], $holi )){
          ...
          if($this->schedlabsModel->edit($id, $_POST)){
            ...
            $this->session->setFlashData('success_message', 'Sucessfuly edited a scheduled event');
          } else {
  ...
  public function delete($id){
    ...
    if($schedlabsModel->inactive($id)) {
      ...
      $this->session->setFlashData('success_message', 'Successfully deleted a scheduled event');
    } else {
      $this->session->setFlashData('error_message', 'Something went wrong!');
    }
    return redirect()->to(base_url('admin/schedlabs'));
  ...
  public function active($id){
    ...
    if($schedlabsModel->active($id)) {
      ...
      $this->session->setFlashData('success_message', 'Successfully restored a scheduled event');
    } else {
      $this->session->setFlashData('error_message', 'Something went wrong!');
    }
    return redirect()->to(base_url('admin/schedlabs'));
