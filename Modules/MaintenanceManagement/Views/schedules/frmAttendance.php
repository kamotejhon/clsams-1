            ...
            <div class="card">
                <div class="card-header">
                  ...
                  <div class="form-group col-md-6 offset-md-3">
                      ...
                      <span>  <?= isset($info['event_name']) ? 'Event: '.$info['event_name']:'Subject: '.$info['subj_code'].' - '.$info['subj_name']; ?> <br> Course: <?= $info['course_name']?><br> Section: <?= $info['year'].'-'.$info['section']?> <br> Date:  <?= $data['date']?> <br> Time: <?= date('h:i:s A', strtotime($info['start_time']))?> - <?=date('h:i:s A', strtotime($info['end_time']))?></span>
                      <br>
                       <center><label for="stud_num" class="form-label">Student Number</label></center>
                      <input name="stud_num" class="form-control" type="text" autocomplete="on" id="stud_num" placeholder="Scan/Input your Student Number!" required>
                  </div>
                  <div class="col-md-12">

                <center>
                  <button id="time_in" type="submit" class="btn btn-success m-5">TIME IN / TIME OUT</button>
