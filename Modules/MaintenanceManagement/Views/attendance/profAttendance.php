                ...
                <div class="row">
                  ...
                  <div class="form-group">
                      ...
                      <select name="professor_id" id="professor_id" class="form-control">
                        ...
                        <option value="<?= $professor['id'] ?>" <?=   ($professor['id'] == isset($value['professor_id'])) ? 'selected':'' ?>><?= ucwords($professor['last_name']) ?>, <?= ucwords($professor['first_name']) ?> <?= ucwords($professor['m_initial']) ?></option>
                        <?php endforeach; ?>
                      <!--  -->
                      </select>
                    </div>
