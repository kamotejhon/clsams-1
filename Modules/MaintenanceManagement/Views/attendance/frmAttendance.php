                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="section_id" id="section_id" class="form-control">
                          ...
                          <option value="<?= $section['id'] ?>" <?=   ($section['id'] == isset($value['section_id'])) ? 'selected':'' ?>><?= ucwords($section['year']) ?> - <?= ucwords($section['section']) ?></option>
                          <?php endforeach; ?>
                        <!--  -->
                        </select>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <select name="semester_id" id="semester_id" class="form-control">
                          ...
                          <option value="<?= $semester['id'] ?>" <?=   ($semester['id'] == isset($value['semester_id'])) ? 'selected':'' ?>><?= ucwords($semester['sem']) ?></option>
                          <?php endforeach; ?>
                        <!--  -->
                        </select>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <select name="sy_id" id="sy_id" class="form-control">
                          ...
                          <option value="<?= $schoolyear['id'] ?>" <?=   ($schoolyear['id'] == isset($value['sy_id'])) ? 'selected':'' ?>><?= ucwords($schoolyear['start_sy']) ?> - <?= ucwords($schoolyear['end_sy']) ?></option>
                          <?php endforeach; ?>
                        <!--  -->
                        </select>
                      </div>
