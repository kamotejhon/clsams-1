                  ...
                  <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group" id="date-div">
                          ...
                          <input type="date" class="form-control" value="isset($value['date']) ? $value['date']: '' "placeholder="Date" id="date" name="date[]">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="category_id" id="category_id" class="form-control">
                          ...
                          <option value="<?= $category['id'] ?>" <?=   ($category['id'] == isset($value['category_id'])) ? 'selected':'' ?>><?= ucwords($category['category']) ?></option>
                          <?php endforeach; ?>
                        <!--  -->
                        </select>
                      </div>
