                    ...
                    <div class="row">
                      <div class="col-md-6" id="first-column">
                        <div class="form-group">
                          ...
                          <select name="subject_id" id="subject_id" class="form-control">
                            ...
                            <option value="<?= $subject['id'] ?>" <?=   isset($value['subject_id']) ? ($subject['id'] == $value['subject_id']) ? 'selected':'' : '' ?>><?= ucwords($subject['subj_name']) ?></option>
                            <?php endforeach; ?>
                          <!--  -->
                          </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="course_id" id="course_id" class="form-control">
                              ...
                              <option value="<?= $course['id'] ?>" <?= isset($value['course_id']) ?  ($course['id'] == $value['course_id']) ? 'selected':'':'' ?>><?= ucwords($course['course_abbrev']) ?> - <?= ucwords($course['course_name']) ?></option>
                              <?php endforeach; ?>
                            <!--  -->
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <select name="section_id" id="section_id" class="form-control">
                            ...
                            <option value="<?= $section['id'] ?>" <?= isset($value['section_id']) ?  (($section['id'] == $value['section_id']) ? 'selected':'') :''?>><?= ucwords($section['year']) ?> - <?= ucwords($section['section']) ?></option>
                            <?php endforeach; ?>
                          <!--  -->
                          </select>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <select name="lab_id" id="lab_id" class="form-control">
                            ...
                            <option value="<?= $lab['id'] ?>" <?=   ($lab['id'] == isset($value['lab_id'])) ? 'selected':'' ?>><?= ucwords($lab['lab_name']) ?></option>
                            <?php endforeach; ?>
                          <!--  -->
                          </select>
                        </div>
                      ...
                      <div class="form-group">
                          ...
                          <select name="category" id="category" class="form-control">
                            ...
                            <option value="1" <?= isset($value['category']) ? ($value['category']  == 1) ? 'selected':'':'' ?>> Regular Class</option>
                            <option value="2" <?= isset($value['category']) ? ($value['category']  == 2) ? 'selected':'':'' ?>> Make-up Class</option>
                          </select>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <select name="semester_id" id="semester_id" class="form-control">
                            ...
                            <option value="<?= $semester['id'] ?>" <?=  isset($value['semester_id']) ? ($semester['id'] == $value['semester_id']) ? 'selected':'':'' ?>><?= ucwords($semester['sem']) ?></option>
                            <?php endforeach; ?>
                          <!--  -->
                          </select>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <select name="sy_id" id="sy_id" class="form-control">
                            ...
                            <option value="<?= $schoolyear['id'] ?>" <?=   isset($value['sy_id']) ? ($schoolyear['id'] == $value['sy_id']) ? 'selected':'':'' ?>><?= ucwords($schoolyear['start_sy']) ?> - <?= ucwords($schoolyear['end_sy']) ?></option>
                            <?php endforeach; ?>
                          <!--  -->
                          </select>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <select name="professor_id" id="professor_id" class="form-control">
                            ...
                            <option value="<?= $prof['id'] ?>" <?= isset($value['professor_id']) ? ($prof['id'] == $value['professor_id']) ? 'selected':'':'' ?>><?= ucwords($prof['first_name']) ?> <?= ucwords($prof['last_name']) ?> <?= ucwords($prof['suffix_name']) ?> </option>
                            <?php endforeach; ?>
                          <!--  -->
                          </select>
                        </div>
